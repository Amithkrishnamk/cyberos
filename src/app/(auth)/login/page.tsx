...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md bg-[#111827] border border-[#1f293d] rounded-xl shadow-2xl p-8 relative z-10 font-mono">
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-sm text-slate-400 mt-1">Authenticate to access platform</p>
      </div>
